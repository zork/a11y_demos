...
var TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 1310720000;
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'game.wast';
  var wasmBinaryFile = 'game.wasm';
  var asmjsCodeFile = 'game.temp.asm.js';
...
STATICTOP = STATIC_BASE + 145152;
/* global initializers */ if (!ENVIRONMENT_IS_PTHREAD) __ATINIT__.push({ func: function() { __GLOBAL__sub_I_wasm_engine_cpp() } }, { func: function() { __GLOBAL__sub_I_message_queue_cpp() } }, { func: function() { __GLOBAL__sub_I_thread_util_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { ___emscripten_pthread_data_constructor() } });


if (!ENVIRONMENT_IS_PTHREAD) {
memoryInitializer = "game.js.mem";
}




var STATIC_BUMP = 145152;
...
// {{PRE_LIBRARY}}
  ...
  function _ConsoleError(message) {
    if (message === 0) return;
  ...
  function _ConsoleWarn(message) {
    if (message === 0) return;
    message = Pointer_stringify(message);
    console.warn(message);
  }

  function _WasmAccessibilityAnnounce(text) {
    if (a11yRootNode != undefined) {
      if (text === 0) return;
      text = Pointer_stringify(text);
      console.log("WasmAccessibilityAnnounce: " + text);
      // TODO: Announce
    }
  }

  function _WasmFocusedViewChanged(id) {
    console.log("WasmFocusedViewChanged: " + id);
    a11yFocusView(id);
  }

  function _WasmHandleTextChanged(viewId) {
    console.log("WasmHandleTextChanged: " + viewId);
    a11yRefreshView(viewId);
  }

  function _WasmHandleViewChanged(id) {
    console.log("WasmHandleViewChanged: " + id);
    if (a11yRootNode != undefined) {
      // TODO: Announce title
    }
  }

  function _WasmInvalidateRootView() {
    console.log("WasmInvalidateRootView");
    a11yInvalidateView(-1);
  }

  function _WasmInvalidateView(id) {
    console.log("WasmInvalidateView: " + id);
    a11yInvalidateView(id);
  }

  function _WasmLockMouse() {
  ...
  function _WasmUpdateTextEditSelection(start, end) {
    updateTextEditSelection(start, end);
  }

  function _WasmUpdateTextEditText(start, end, text) {
    text = Pointer_stringify(text);
    updateTextEditText(start, end, text);
  }
  ...
  var _stderr; if (ENVIRONMENT_IS_PTHREAD) _stderr = PthreadWorkerInit._stderr; else PthreadWorkerInit._stderr = _stderr = allocate(1, "i32*", ALLOC_STATIC);var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
      ...
      }};function ___syscall10(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(138, 10, varargs) }
  ...
  function ___syscall196(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(138, 196, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // SYS_lstat64
      var path = SYSCALLS.getStr(), buf = SYSCALLS.get();
  ...
  function ___syscall220(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(138, 220, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // SYS_getdents64
  ...
  function ___syscall39(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(138, 39, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // mkdir
  ...
  function ___syscall40(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(138, 40, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // rmdir
      var path = SYSCALLS.getStr();
  ...
  function ___syscall91(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(138, 91, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // munmap
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(2, deviceId);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_iii(3, deviceId, pAttrList);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_vi(4, contextId);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(5, contextId);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_iii(6, deviceId, param);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(7, contextId);
      if (contextId === 0) {
        AL.currentCtx = null;
        return 0;
      } else {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(8, pDeviceName);
      if (pDeviceName) {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(9, name);
...
var proxiedFunctionTable = [null,_atexit,_alcCloseDevice,_alcCreateContext,_alcDestroyContext,_alcGetContextsDevice,_alcGetString,_alcMakeContextCurrent,_alcOpenDevice,_getenv];
...
var real___GLOBAL__sub_I_message_queue_cpp = asm["__GLOBAL__sub_I_message_queue_cpp"]; asm["__GLOBAL__sub_I_message_queue_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_message_queue_cpp.apply(null, arguments);
};

var real___GLOBAL__sub_I_thread_util_cpp = asm["__GLOBAL__sub_I_thread_util_cpp"]; asm["__GLOBAL__sub_I_thread_util_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_thread_util_cpp.apply(null, arguments);
};

var real___GLOBAL__sub_I_wasm_engine_cpp = asm["__GLOBAL__sub_I_wasm_engine_cpp"]; asm["__GLOBAL__sub_I_wasm_engine_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_wasm_engine_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_message_queue_cpp = Module["__GLOBAL__sub_I_message_queue_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_message_queue_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_thread_util_cpp = Module["__GLOBAL__sub_I_thread_util_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_thread_util_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_wasm_engine_cpp = Module["__GLOBAL__sub_I_wasm_engine_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_wasm_engine_cpp"].apply(null, arguments) };
